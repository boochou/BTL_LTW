<div class="row">
    ...
    <div class="row mt-3 mb-3 d-flex">
        <div
        class="col-4 col-lg-2 d-flex flex-column align-items-center justify-content-center"
        >
        <a
            id="rate"
    ...
    <div class="row border rounded-4">
        ...
        <a class="ms-2 text-decoration-none me-5" style="color: black"
            ><span>ANH</span> - Đơn hàng: <span>ABCD</span></a
        >
        <a class="ms-2 text-decoration-none me-5" style="color: #939292"
            ><span>3 ngày trước</span></a
        >
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
