<div class="row">
    ...
    <nav aria-label="breadcrumb" class="d-none d-md-flex d-lg-flex ms-5">
        ...
        <li class="breadcrumb-item">
            <a href="?page=community" class="text-decoration-none" style="color: black"
            >Giao tiếp</a
            >
        </li>
        <li class="breadcrumb-item">
    ...
    <div style="max-height: 650px; overflow-y: auto; overflow-x: hidden;">
        <?php
            $sortOption = "newest";
            include_once("../../controller/seller/getRatings.php");
            $ratings = fetchRatings($sortOption);
    ...
    <div class="row border rounded-4 me-5 ms-5 mb-3">
        ...
        <div class="col-12 d-flex flex-column mt-3">
            <a class="text-decoration-none" style="color: black;">
                <span class=" ms-2 text-decoration-underline fw-light" data-bs-toggle="modal" data-bs-target="#<?php echo $modalIduser; ?>">Xem thông tin</span>
                <?php if ($itemm['isReported'] == 0) { ?>
                        <span class="text-decoration-underline fw-light ms-3" style="color:red" onclick="reportUser(<?php echo $itemm['id']; ?>)">Chặn</span>
                        <?php } 
                    ?>
                    <?php if ($itemm['isReported'] == 1) { ?>
                        <span class="text-decoration-underline fw-light ms-3" style="color:red" onclick="unblockUser(<?php echo $itemm['id']; ?>)">Gỡ chặn</span>
                        <?php } 
                    ?>
            </a>
                <?php
            ...
            $listPIO = fetchProductInOrder($itemm['idOrder']);
            $productList = "";
        ...
        <div class="col-12 d-flex flex-row ms-2 mt-3 mb-3">
            <?php if ($itemm['respone'] == null) { ?>
                <button type="button" class="btn btn-outline-warning me-3" data-bs-toggle="modal" data-bs-target="#<?php echo $modalId; ?>">PHẢN HỒI</button>
                <?php } 
                    ?>
            <?php if ($itemm['isHidden'] == 0) { ?>
                <button type="button" class="btn btn-outline-warning" style="color: red" onclick="hideRating(<?php echo $itemm['ID']; ?>)">ẨN NHẬN XÉT</button>
                <?php } 
                    ?>
        </div>
