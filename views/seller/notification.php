<div class="col align-items-center justify-content-center mt-3 me-3">
    <nav aria-label="breadcrumb" class="d-none d-md-flex d-lg-flex ms-5">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" class="text-decoration-none" style="color: black;">Trang
                    chủ</a></li>
            <li class="breadcrumb-item"><a href="#" class="text-decoration-none" style="color: black;">Giao
                    tiếp</a></li>
            <li class="breadcrumb-item"><a href="./notification.html" class="text-decoration-none"
                    style="color: black;">Thông báo</a></li>
        </ol>
    </nav>
            ...
            <div class="row">
                ...
                <div class="col-9 d-flex flex-column justify-content-center mt-2 mb-2">
                    <a class="fw-bold text-decoration-none mt-2 mb-2" style="color: black;">
                        ...
                        Bạn có đơn hàng mới!</a>
                    <a class="text-decoration-none mt-2 mb-2" style="color: black;">Đơn hàng ABCDXYZ nóng hổi
                        vừa mới đến. Hãy xác nhận đơn và thực hiện đơn hàng cho khách yêu của bạn nào!</a>
                    <a class="text-decoration-none mt-2 mb-2" style="font-size: 13px; color:#A29D9D">20:00
                        28/09/2023 </a>
                    <button type="button" class="btn btn-outline-warning mt-2 mb-2 me-5"
                        onclick="readNotification()">ĐÃ ĐỌC</button>
