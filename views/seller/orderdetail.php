    ...
    <div class="col align-items-center justify-content-center mt-3 me-3">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center mt-3 ms-5 me-5 mb-4">
            <a class="text-decoration-none  fw-bold"
                style="color: black;"><?php echo $orderDetail[0]['dateCreated'] ?></a>
        ...
        <div class="row ms-5 me-5 border rounded-4 mt-3 mb-3">
            <div class="col-2 d-flex justify-content-center align-items-center mt-2 mb-2">
                <img src="https://clipart-library.com/images_k/transparent-food-clipart/transparent-food-clipart-10.png"
                    alt="order image" width="40" height="40">
            </div>
            <div class="col-8 d-flex align-items-center">
                <div class="d-flex flex-column justify-content-center mt-2 mb-2">
                    <a class="text-decoration-none  fw-bold"
                        style="color: black;"><?php echo $orderDetail[0]['userName'] ?></a>
                    <a class="text-decoration-none  fw-light"
                        style="color: black;"><?php echo $orderDetail[0]['statusOrder'] ?></a>
                </div>
            </div>
        </div>
        <div class="d-flex ms-5 me-5 mb-3 align-items-center justify-content-center">
            <img src="../../public/images/map.png" alt="map" class="img-fluid">
        </div>
        <div class="row ms-5 me-5 border rounded-4 mt-3 mb-3">
            <div class="col-2 d-flex flex-column justify-content-center align-items-center mt-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="blue"
                    class="bi bi-geo-alt-fill mb-3" viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-geo-alt-fill"
                    viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                </svg>
            </div>
                ...
                foreach ($orderDetail[0]['product'] as $key => $productArray) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 d-flex flex-column justify-content-center mb-2">
                            ...
                            <a class="text-decoration-none fw-light"
                                style="color: black;"><?php echo $productArray['proNote'] ?> </a>
                        </div>
                        <div class="col-2 d-flex justify-content-center  mb-2">
                            <a class="text-decoration-none"
                                style="color: black;"><span><?php echo number_format((int) $productArray['proPrice']) ?></span>đ
                            </a>
                        </div>
                    </div>
                    <?php
        ...
        <div class="row ms-5 me-5 border rounded-4 mt-3 mb-3">
            <div class="col-2 d-flex flex-column justify-content-center align-items-center mt-2 mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFC700" class="bi bi-pen mb-3"
                    viewBox="0 0 16 16">
                    <path
                        d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z" />
                </svg>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFC700" class="bi bi-wallet2"
                    viewBox="0 0 16 16">
                    <path
            ...
            <div class="text-center">
                ...
                <?php elseif ($orderDetail[0]['statusOrder'] == 'Đang giao hàng'): ?>
                    <button class="btn mt-2 mb-2" style="background-color: #FFC700;"
                        onclick="completeOrder('<?php echo $orderDetail[0]['idOrder']; ?>')">
                        <i class="fas fa-check-circle"></i> Đã hoàn thành
                    </button>
                <?php elseif ($orderDetail[0]['statusOrder'] != 'Đã hoàn thành' && $orderDetail[0]['statusOrder'] != 'Đang giao hàng'): ?>
                    <button class="btn mt-2 mb-2" style="background-color: #FFC700;"
                        onclick="prepareOrder('<?php echo $orderDetail[0]['idOrder']; ?>')">
